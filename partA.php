    ...
    <div class="col offset-md-2 parta" id="part-a-container">
    	...
    	<header>
			...
			if($_SESSION['id']==$userId)
			{
				...
				else
				{
					...
					else
					{
						$submitted_for_review=true;
						?>
						<p class=""><i class="fas fa-check" style="color: green;font-size: 20px" class="mr-1"></i> Submitted for CAS Review</p>
						<?php
					}
			...
			if($_SESSION['id']==$userId)
			{
				...
				{
					?>
					<form method="POST" id="ssaA_sys" action="ssaA_sys.php" onsubmit="return confirm('Do you want to submit the form for Self Appraisal?');">
						<input type="hidden" name="year" id="year" value="<?php echo $year; ?>">
