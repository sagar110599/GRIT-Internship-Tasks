							...
							<div class="row">
								...
								<div class="col-md-9">
									...
									<div class="custom-control custom-checkbox">
									  <input type="checkbox" class="custom-control-input" id="defaultCheckedFaculty" value="faculty" name="faculty" checked>
									  <label class="custom-control-label" for="defaultCheckedFaculty" style="color: #a6a6a6">Faculty</label>
									</div>

									<div class="custom-control custom-checkbox">
									  <input type="checkbox" class="custom-control-input" id="defaultCheckedH.O.D" value="hod" name="hod">
									  <label class="custom-control-label" for="defaultCheckedH.O.D" style="color: #a6a6a6">H.O.D</label>
									</div>

									<div class="custom-control custom-checkbox">
									  <input type="checkbox" class="custom-control-input" id="defaultCheckedCommittee" value="committee" name="committee">
									  <label class="custom-control-label" for="defaultCheckedCommittee" style="color: #a6a6a6">Committee</label>
									</div>

									<div class="custom-control custom-checkbox">
									  <input type="checkbox" class="custom-control-input" id="defaultCheckedPrincipal" value="principal" name="principal">
